...
export default function About() {
  return (
    <section id="about-section" className="about-section border-t border-stone-200 px-6 py-24 dark:border-stone-800">
      <div className="mx-auto max-w-5xl">
        <Reveal>
          <SectionHeading>About</SectionHeading>
        </Reveal>

        <Reveal delay={100} className="mt-8 grid gap-10 lg:grid-cols-[1fr_auto]">
          <>
